 ...
 */
void EvilHookStubFunctionForIBored(struct pt_regs *regs)
{
...
void ModifyIBored()
{
    ...
    void* pModuleBaseAddr = GetModuleBaseAddr(-1, "hook");
    ...
    uint32_t uiHookAddr = (uint32_t)pModuleBaseAddr + 0x1a88;
